...
5. **Config:**
  ...
  - ⚠️ You will get an error when setup is complete, just click ok and say `Miles` and speak a prompt like `Are you there?`. After you do that, everything will now be working.
